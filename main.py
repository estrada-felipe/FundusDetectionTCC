...
data_augmentation_config = {
    'rotation_range': 10,          # Aumenta para ±10 graus
    'width_shift_range': 0.07,      # Deslocamento horizontal de até 10%
    'height_shift_range': 0.07,     # Deslocamento vertical de até 10%
    'shear_range': 0.1,            # Pequena distorção angular (10%)
